	...
	private void initConnectionPool(){
		try{
			...
			ConnectionFactory connFactory = 
					new DriverManagerConnectionFactory(jdbcDriver, user, pass);
	        ...
	        //커넥션 풀 등록시, 풀의 이름으로 'chap14'를 사용하였음.
	        
	        //커넥션 풀의 이름 (jdbc:apache:commons:dbcp:chap14) -> chap14, 통상적으로 DB이름과 똑같이 쓴다.
